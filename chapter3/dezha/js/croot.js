...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/dezhamartha17/dezhamartha17.github.io/main/chapter3/point.json") // Ganti "data.json" dengan nama file JSON Anda
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/dezhamartha17/dezhamartha17.github.io/main/chapter3/polygon.json") // Ganti "data.json" dengan nama file JSON Anda
        .then(response => response.json())
        .then(data => {
            data.features.forEach(feature => {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/dezhamartha17/dezhamartha17.github.io/main/chapter3/polyline.json") // Ganti "data.json" dengan nama file JSON Anda
        .then(response => response.json())
        .then(data => {
            data.features.forEach(feature => {
...
const polygonGeoJSONUrl = 'https://raw.githubusercontent.com/dezhamartha17/dezhamartha17.github.io/main/chapter3/polygon.json';
const lineStringGeoJSONUrl = 'https://raw.githubusercontent.com/dezhamartha17/dezhamartha17.github.io/main/chapter3/polyline.json';
const pointGeoJSONUrl = 'https://raw.githubusercontent.com/dezhamartha17/dezhamartha17.github.io/main/chapter3/point.json';
